<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HistorialSecre.aspx.cs" Inherits="Regentes.HistorialSecre" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <center>
            ...
            <tr>
                ...
                <MasterTableView DataKeyNames="CodRegente,Nombre,CodReg,CodregEMPF,CODregECUT,Correo,Telefono,Profesion,FecCreacion,Estatus,codestatus,nus,tipotramite,codtramite">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Dias" Visible="true" UniqueName="dia" AllowFiltering="false" ShowFilterIcon="false" HeaderText="Días en CONAP"  HeaderStyle-Width="100px">
                        </telerik:GridBoundColumn>
                        <telerik:GridTemplateColumn HeaderText="Procesar" UniqueName="Procesa" Visible="false"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>
        ...
        <tr>
            <td>
                <asp:Label ID="Label3" Font-Bold="true" runat="server" Text="Historial de Recepción" Font-Size="Large"></asp:Label>
            </td>
        </tr>
            <tr>
                <td>

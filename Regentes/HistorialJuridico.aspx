<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HistorialJuridico.aspx.cs" Inherits="Regentes.HistorialJuridico" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <SCRIPT language="JavaScript">
     ...
     <table>
            <tr>
                <td>
                    <asp:Label ID="Label1" Font-Bold="true" runat="server" Text="Historial de Expedientes" Font-Size="X-Large"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <MasterTableView DataKeyNames="CodRegente,Nombre,CodReg,CodregEMPF,CODregECUT,Correo,Telefono,Profesion,FecCreacion,Estatus,codestatus,nus,tipotramite,codtramite">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Dictamen" Visible="false" UniqueName="Procesa"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="ImgDictamen" ImageUrl="~/Imagenes/dictamen.png" CommandName="CmdProcesar"/>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Imprimir Dictamen" UniqueName="PrintDic"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="ImgPrintDictamen" ImageUrl="~/Imagenes/print.png" CommandName="CmdPrintDictamen"/>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>  
                         <telerik:GridTemplateColumn HeaderText="Resolución" Visible="false" UniqueName="Procesa"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="ImgResulucion" ImageUrl="~/Imagenes/open.png" CommandName="CmdResolucion"/>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>  
                        ...
                        <telerik:GridTemplateColumn HeaderText="Enviar a Director" UniqueName="SendDir" Visible="false"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="ImgSend" Visible="false" ImageUrl="~/Imagenes/mail.png" CommandName="CmdSend"/>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>  
                    </Columns>        
                </MasterTableView>
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" Font-Bold="true" runat="server" Text="Historial de Enmiendas Legales" Font-Size="Large"></asp:Label>
            </td>
        </tr>
            <tr>
                <td>
                    <telerik:RadGrid runat="server" ID="GrdEnmiendaLeg" PageSize="15" 
                AutoGenerateColumns="false" Width="100%" AllowSorting="true" 

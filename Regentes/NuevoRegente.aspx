<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NuevoRegente.aspx.cs" Inherits="Regentes.NuevoRegente" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <center>
        <table>
            <tr>
                <td colspan="4">
                    <asp:Label ID="Label1" runat="server" Font-Bold="true" Text="FORMULARIO DE SOLICITUD PARA REGISTRO DE REGENTES FORESTALES EN ÁREAS PROTEGIDAS" Font-Size="Large"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="4">
            ...
            <tr>
                ...
                <td>
                    <telerik:RadTextBox runat="server" onkeydown = "return (event.keyCode!=13);" ID="TxtNoRegistroRG" Width="200px"></telerik:RadTextBox>
                </td>
                <td>
                ...
                <td>
                    <telerik:RadTextBox runat="server" onkeydown = "return (event.keyCode!=13);" ID="TxtNoRegistroEMPF" Width="200px"></telerik:RadTextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <telerik:RadTextBox runat="server" onkeydown = "return (event.keyCode!=13);" ID="TxtNoRegistroECUT" Width="200px"></telerik:RadTextBox>
                </td>
                <td></td>
                <td></td>
            </tr>
             <tr>
                ...
                <td>
                    <telerik:RadTextBox runat="server" onkeydown = "return (event.keyCode!=13);" ID="TxtApellidos" Width="200px"></telerik:RadTextBox>
                ...
                <td>
                    <telerik:RadTextBox runat="server" onkeydown = "return (event.keyCode!=13);" ID="TxtNombres" Width="200px"></telerik:RadTextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <telerik:RadNumericTextBox runat="server" onkeydown = "return (event.keyCode!=13);"  ID="TxtDocId"  Width="200px" MaxLength="13">
                ...
                <td>
                    <telerik:RadTextBox onkeydown = "return (event.keyCode!=13);" runat="server" ID="TxtNit" Width="200px"></telerik:RadTextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <telerik:RadTextBox onkeydown = "return (event.keyCode!=13);" runat="server" ID="TxtNacionalidad" Width="200px"></telerik:RadTextBox>
                </td>
                <td>
                ...
                <td>
                   <telerik:RadComboBox runat="server"  ID="CboGenero" Width="200px"></telerik:RadComboBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <telerik:RadDatePicker onkeydown = "return (event.keyCode!=13);" ID="TxtFecNac" MinDate="01/01/1930" Width="200px" runat="server"></telerik:RadDatePicker>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label66" runat="server" Text="Años a solicitar:"></asp:Label>
                </td>
                <td colspan="3">
                    <telerik:RadNumericTextBox runat="server" onkeydown = "return (event.keyCode!=13);" ID="TxtAnis" Width="75px">
                        <NumberFormat DecimalDigits="0" />
                    </telerik:RadNumericTextBox>
                    <asp:CheckBox runat="server" Text="¿Desea que su currículo sea público?" ID="ChkPublico" Checked="true" />
                </td>
            ...
            <tr>
                <td colspan="4">
                    <asp:Label ID="LblGrabo" runat="server" Font-Bold="true" Visible="false" ForeColor="Red"  Font-Size="Larger"></asp:Label>
                </td>
            </tr>
        </table>
    </center>
</div>
<div id="Div1" runat="server" visible="false" class="redondo">
    <center>
        <table>
            <tr>
                <td colspan="4">
    ...
    <table>
        ...
        <tr>
            <td colspan="4">
                <asp:Label ID="Label51" Font-Bold="true" runat="server" Text="Experiencia laboral relacionada con materia forestal y/o administración de Áreas Protegidas" Font-Size="Large"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="4">
    ...
    <table>
       ...
       <tr>
        ...
        <tr>
            <td>
                <asp:Label runat="server" Text="Institución para la que trabaja actualmente:"></asp:Label>
            </td>
            <td colspan="3">
    ...
    <table>
        ...
        <tr>
            <td colspan="4">
                <asp:Label ID="Label57" Font-Bold="true" runat="server" Text="Experiencia como regente forestal y elaborador de planes de manejo forestal" Font-Size="Large"></asp:Label>
            </td>

        </tr>
        <tr>
            <td colspan="4">
                <asp:Label ID="Label36" runat="server" Text="Manejo de bosques naturales (latifoliados, coníferas, etc.), establecimiento y manejo de plantaciones forestales, otros estudios afines en materia forestal. "></asp:Label>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Label61" runat="server" Text="Área Forestal (ha)"></asp:Label>
            </td>
            <td>
                ...
                <MasterTableView DataKeyNames="CodRegente,Corr,Finca,ubicacion,tipoactividad,area,periodo">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Finca" HeaderText="Finca"  HeaderStyle-Width="225px">
                         ...
                         <telerik:GridBoundColumn DataField="area" HeaderText="Área"  HeaderStyle-Width="225px">
                            <HeaderStyle Width="225px"></HeaderStyle>
                        </telerik:GridBoundColumn> 
    ...
    <table>
        <tr>
         ...
         <tr>
           <td colspan="4">
                <asp:Label ID="LblAutorizacion" runat="server" Visible="false" Font-Bold="true"  ForeColor="Red" Font-Size="Medium"></asp:Label>
           </td> 
        </tr>
        <tr>
            <td colspan="4">
                <asp:Label ID="Label63" runat="server" Text="Observaciones"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="4">
                <telerik:RadTextBox runat="server" TextMode="MultiLine" onkeydown = "return (event.keyCode!=13);" ID="TxtObservacionGen" Height="50px" Width="400px"></telerik:RadTextBox>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label64" runat="server" Text="Fecha de Presentación" Visible="false"></asp:Label>
            </td>
            <td>
                <telerik:RadDatePicker onkeydown = "return (event.keyCode!=13);" ID="TxtFecPresentacion" Visible="false" Width="200px" runat="server"></telerik:RadDatePicker>
            </td>
            <td></td>
            <td></td>
        </tr>
        <tr>
            <td colspan="4">
                <asp:CheckBox runat="server" Text="" ID="ChkAutoriza" AutoPostBack="true" />
            </td>
        </tr>
        <tr>
            <td colspan="4">
                <telerik:RadButton runat="server" ID="BtnGrabarTodo" Visible="false" Text="Grabar Solicitud e Imprimir" Height="35px"></telerik:RadButton>
                <telerik:RadButton runat="server" ID="BtnImprimeCV" Visible="false" Text="Imprimir Curriculum" Height="35px"></telerik:RadButton>
                <asp:ImageButton runat="server" ToolTip="Salir" ImageUrl="~/Imagenes/logoout.ico" PostBackUrl="~/Logon.aspx" />
            </td>
        </tr>
        <tr>
            <td colspan="4">

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegentesProceso.aspx.cs" Inherits="Regentes.RegentesProceso" %>
...
<SCRIPT language="JavaScript">
    ...
    function url3(CodRegente, nus, tramite) {
    ...
    function url6(CodRegente,Corr,nus) {
        hidden = open('RepIngresoExp.aspx?CodRegente=' + CodRegente + '&Corr=' + Corr + '', 'NewWindow', 'top=0,left=0,width=800,height=600,status=yes,resizable=yes,scrollbars=yes');
    }
...
<center>
    <table>
            <tr>
                <td>
                    <asp:Label ID="Label1" Font-Bold="true" runat="server" Text="Regentes en Proceso" Font-Size="X-Large"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <MasterTableView DataKeyNames="CodRegente,Nombre,CodReg,CodregEMPF,CODregECUT,FecCreacion,Estatus,codestatus,nus,codestatus,nus,tipotramite,codtramite">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Estatus" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" AndCurrentFilterFunction="Contains"  HeaderText="Estatus"  HeaderStyle-Width="225px">
                            <HeaderStyle Width="225px"></HeaderStyle>
                        </telerik:GridBoundColumn>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ExpBaja.aspx.cs" Inherits="Regentes.ExpBaja" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <center>
        <table>
            <tr>
                <td>
                    <asp:Label ID="Label1" Font-Bold="true" runat="server" Text="Solicitudes dadas de baja" Font-Size="X-Large"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <MasterTableView DataKeyNames="CodRegente,Nombre,CodReg,CodregEMPF,CODregECUT,Correo,Telefono,Profesion,FecCreacion,Estatus,codestatus,nus,tipotramite,codtramite,Region">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="FecCreacion" AllowFiltering="false" ShowFilterIcon="false" HeaderText="Ingreso a CONAP"  HeaderStyle-Width="225px">
                            <HeaderStyle Width="225px"></HeaderStyle>
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="Region" AllowFiltering="false" ShowFilterIcon="false" HeaderText="Región que dio baja"  HeaderStyle-Width="225px">
                            <HeaderStyle Width="225px"></HeaderStyle>
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Procesar" Visible="false" UniqueName="Procesa"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="ImgEditar" ImageUrl="~/Imagenes/process.png" CommandName="CmdProcesar"/>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>  
                        <telerik:GridTemplateColumn HeaderText="Historial" Visible="false" UniqueName="Histori"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="Imghistory" ImageUrl="~/Imagenes/histori.png" CommandName="CmdHistoria"/>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn> 
                        <telerik:GridTemplateColumn HeaderText="Dar de baja"  Visible="false" UniqueName="Baja"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>
                        ...
                        <telerik:GridBoundColumn DataField="Dias" Visible="false" UniqueName="dia" AllowFiltering="false" ShowFilterIcon="false" HeaderText="Días en CONAP"  HeaderStyle-Width="100px">
                        </telerik:GridBoundColumn>
                    </Columns>        
                </MasterTableView>
        ...
        <tr>
            <td>
                <asp:Label ID="Label3" Font-Bold="true" runat="server" Text="Historial de Expedientes" Visible="false"  Font-Size="Large"></asp:Label>
            </td>
        </tr>
            <tr>
                <td>
                    <telerik:RadGrid runat="server" ID="Grdhistoria" PageSize="15" Visible="false"
                AutoGenerateColumns="false" Width="100%" AllowSorting="true" 
                ...
                <MasterTableView DataKeyNames="CodRegente,Corr,Fecrecibe">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Ver" Visible="false" UniqueName="VerTrans"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="Imghistory" ImageUrl="~/Imagenes/view.png" CommandName="CmdHistoria"/>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn> 
                        <telerik:GridTemplateColumn HeaderText="Impresion Constancia" Visible="false" UniqueName="Print"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>

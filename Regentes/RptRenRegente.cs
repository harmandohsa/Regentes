...
namespace Regentes {
    ...
    public class RptRenRegente : ReportClass {
        
        public RptRenRegente() {
        }
        
        public override string ResourceName {
            get {
                return "RptRenRegente.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Regentes.RptRenRegente.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptRenRegente : Component, ICachedReport {
        
        public CachedRptRenRegente() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptRenRegente rpt = new RptRenRegente();
            rpt.Site = this.Site;
            return rpt;
        }

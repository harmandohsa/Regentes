<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SolicitaEnmienda.aspx.cs" Inherits="Regentes.SolicitaEnmienda" %>
...
<div class="redondo">
    <table>
        ...
        <tr>
            <td>
                <asp:Label runat="server" Text="Enmienda:"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <MasterTableView DataKeyNames=" CodRegente,Corr,CorrEnmienda,Enmienda">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Enmienda" UniqueName="Enmienda" HeaderText="Enmienda"  HeaderStyle-Width="225px">
                            <HeaderStyle Width="225px"></HeaderStyle>
                        </telerik:GridBoundColumn>         

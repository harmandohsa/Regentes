...
namespace Regentes {
    ...
    public class RptDictamenTecAct : ReportClass {
        
        public RptDictamenTecAct() {
        }
        
        public override string ResourceName {
            get {
                return "RptDictamenTecAct.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Regentes.RptDictamenTecAct.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptDictamenTecAct : Component, ICachedReport {
        
        public CachedRptDictamenTecAct() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptDictamenTecAct rpt = new RptDictamenTecAct();
            rpt.Site = this.Site;
            return rpt;
        }

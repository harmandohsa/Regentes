<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerJuridico.aspx.cs" Inherits="Regentes.VerJuridico" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
            <tr>
                <td>
                    <asp:Label ID="Label1" Font-Bold="true" runat="server" Text="Dictamen Legal/Resolución" Font-Size="X-Large"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <MasterTableView DataKeyNames="CodRegente,Nombre,CodReg,CodregEMPF,CODregECUT,Correo,Telefono,Profesion,FecCreacion,Estatus,codestatus,nus,tipotramite,codtramite">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Dictamen" UniqueName="Procesa"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Imprimir Dictamen" UniqueName="PrintDic"  AllowFiltering="false" ShowFilterIcon="false"  >
                         ...
                         <telerik:GridTemplateColumn HeaderText="Resolución" UniqueName="Procesa"  AllowFiltering="false" ShowFilterIcon="false"  >
                            <ItemTemplate>

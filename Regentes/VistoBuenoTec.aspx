<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VistoBuenoTec.aspx.cs" Inherits="Regentes.VistoBuenoTec" %>
...
<table>
            <tr>
                <td>
                    <asp:Label ID="Label1" Font-Bold="true" runat="server" Text=" Visto Bueno Dictamen Técnico" Font-Size="X-Large"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <MasterTableView DataKeyNames="CodRegente,Nombre,CodReg,CodregEMPF,CODregECUT,Correo,Telefono,Profesion,FecCreacion,Estatus,codestatus,nus,tipotramite,codtramite">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Estado" UniqueName="Est" AllowFiltering="false" ShowFilterIcon="false" HeaderText="Opinión"  HeaderStyle-Width="100px">
                        </telerik:GridBoundColumn>

...
namespace Regentes {
    ...
    public class RptCurriculu : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Regentes.RptCurriculu.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptCurriculu : Component, ICachedReport {
        
        public CachedRptCurriculu() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptCurriculu rpt = new RptCurriculu();
            rpt.Site = this.Site;
            return rpt;
        }

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HistorialDirector.aspx.cs" Inherits="Regentes.HistorialDirector" %>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <asp:Label ID="Label4" runat="server" Text="Exportar a Pdf"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
